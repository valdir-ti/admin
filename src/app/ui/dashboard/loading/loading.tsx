export default function LoadingUI() {
  return (
    <div aria-label="Loading..." role="status" className="w-full h-screen flex items-center justify-center">
        <svg className="animate-spin w-16 h-auto fill-white" viewBox="3 3 18 18">
